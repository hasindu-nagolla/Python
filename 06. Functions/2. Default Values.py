...
# If the value of the argument is not passed to the function then the default value
# is used.
# ==================================================================================
...
# ===========================================================================================================
# Note: we cannot pass the value of subject without passing the value of marks. because we have not set the 
# default value of marks. also, we cannot create a parameter without a default value after the parameter 
